...
export class SidebarComponent {
  sidebarItems = [
    ...
    { _id: 5, name: "Server", icon: "bi bi-database mx-2", href: '/servers' },
    { _id: 6, name: "Tally Release", icon: "bi bi-x-diamond mx-2", href: '/tally_release' },
    { _id: 7, name: "Subscription", icon: "bi bi-sliders2-vertical mx-2", href: '/subscription' },
